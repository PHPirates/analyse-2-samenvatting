	...
	\section{College 23}
		\subsection{\indx{Impliciete functiestelling}, impliciet differentieren}
			...
			\subsubsection{'Impliciete functies' in meer variabelen}
				...
				\end{rcases*} \Rightarrow \F (\x,\y)=\zero \text{ in } \reals^m \qquad D \subset \reals^{n+m}, F\:  D \to \reals^m
				\]
				
				\theorem[Impliciete functiestelling algemeen] Zij $ D\subset \reals^{n+m} $ open, $ (x_0, y_0) \in D $ d'baar, alle parti\"ele afgeleiden continu. ($ \partial_{x_i}F_j , \partial_{y_k}F_j \quad i=1,\dots,n \quad j,k=1,\dots,m $). Zij ook $ F(x_0, y_0) = \zero$, $ \partial_y F(x_0,y_0) $ regulier, inverteerbaar ($ (m,m) $-Jacobimatrix).
				...
				\end{itemize}
				z.d.d. $ ((\x,\y) \in U \wedge F(\x,\y)=0) \Leftrightarrow \y=\phi (\x). $
